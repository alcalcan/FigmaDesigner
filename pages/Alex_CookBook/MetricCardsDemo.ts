...
import { metric_card as metric_card_Alex_CookBook } from "../../components/Alex_CookBook/metric_card/metric_card";
import { BaseDemoPage } from "./BaseDemoPage";

export class MetricCardsDemo extends BaseDemoPage {
    async create(props: ComponentProps): Promise<SceneNode> {
        ...
        const design1 = new metric_card_Alex_CookBook();
    ...
    private async createCardWithCaption(design: metric_card_Alex_CookBook, row: FrameNode, props: any, caption: string): Promise<FrameNode> {

...
// SVG Assets
const SVG_assets_vector_UEFA_com_858_8512_svg_98_46454620361328x15_945378303527832 = `<svg width="98.46454620361328" height="15.945378303527832" viewBox="0 0 98.46454620361328 15.945378303527832" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
const SVG_assets_icon_Vector_858_8522_svg_14_999951362609863x19_192251205444336 = `<svg width="14.999951362609863" height="19.192251205444336" viewBox="0 0 14.999951362609863 19.192251205444336" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export class Top_bar extends BaseComponent {
    async create(props: ComponentProps): Promise<SceneNode> {
        ...
        const root_child_0_child_0_child_0_child_0_child_0_svgContainer = figma.createNodeFromSvg(SVG_assets_vector_UEFA_com_858_8512_svg_98_46454620361328x15_945378303527832);
        ...
        applySizeAndTransform(root_child_0_child_0_child_1, { "width": 21, "height": 1, "relativeTransform": [[-4.3711395392165286e-8, -1, 67], [1, -4.3711395392165286e-8, 2.1855697696082643e-8]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        applySizeAndTransform(root_child_0_child_0_child_2, { "width": 82, "height": 21, "relativeTransform": [[1, 0, 79], [0, 1, 0]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        applySizeAndTransform(root_child_0_child_0, { "width": 161, "height": 21, "relativeTransform": [[1, 0, 0], [0, 1, 0]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        root_child_0.appendChild(root_child_0_child_0);
        // Child Layout Props
        root_child_0.layoutAlign = "INHERIT";
        root_child_0.layoutGrow = 0;
        applySizeAndTransform(root_child_0, { "width": 161, "height": 21, "relativeTransform": [[1, 0, 40], [0, 1, 9.5]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        // Start Child: Vector
        const root_child_1_child_0_child_0_svgContainer = figma.createNodeFromSvg(SVG_assets_icon_Vector_858_8522_svg_14_999951362609863x19_192251205444336);
        ...
        applySizeAndTransform(root_child_1_child_0, { "width": 24, "height": 24, "relativeTransform": [[1, 0, 749.62060546875], [0, 1, 0]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        applySizeAndTransform(root_child_1_child_1_child_0_child_1, { "width": 24, "height": 1, "relativeTransform": [[-4.3711395392165286e-8, -1, 105], [1, -4.3711395392165286e-8, 2.1855697696082643e-8]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        applySizeAndTransform(root_child_1_child_1_child_0, { "width": 105, "height": 24, "relativeTransform": [[1, 0, 0], [0, 1, 0]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        applySizeAndTransform(root_child_1_child_1, { "width": 105, "height": 24, "relativeTransform": [[1, 0, 797.62060546875], [0, 1, 0]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        ...
        // Union is now child of an Auto Layout frame
        root_child_1_child_2.appendChild(root_child_1_child_2_child_0);
        applySizeAndTransform(root_child_1_child_2_child_0, { "width": 20, "height": 14, "relativeTransform": [[1, 0, 0], [0, 1, 0]], "parentIsAutoLayout": true, "layoutPositioning": "AUTO" });
        // Child Layout Props

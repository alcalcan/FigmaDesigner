      ...
      "children": [
        ...
        },
        {
          ...
          "children": [
            ...
            ...[{ "name": "UEFA Academy", "isSelected": false }, { "name": "UEFA Assist", "isSelected": false }, { "name": "UEFA Events", "isSelected": false }, { "name": "UEFA Football Development", "isSelected": false }, { "name": "UEFA Grow", "isSelected": true, "fillColor": { "r": 0.9450980424880981, "g": 0.9529411792755127, "b": 0.9725490212440491 } }, { "name": "UEFA Hatrick", "isSelected": false }, { "name": "UEFA Anti-Doping and Medical", "isSelected": false }, { "name": "UEFA Intelligence Center", "isSelected": false }].map(item => {
              ...
              if (item.isSelected) {
                ...
                node.props.fills = [{
                  ...
                  opacity: 1,
                  blendMode: "NORMAL",
                  color: item.fillColor || { r: 0.10, g: 0.19, b: 0.23 }, // Match checkbox color
                  boundVariables: {}
                }];
              } else {

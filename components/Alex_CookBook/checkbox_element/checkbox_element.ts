...
applySizeAndTransform(root_child_0, {"width":20,"height":20,"relativeTransform":[[1,0,0],[0,1,2]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
...
// Styled Segments
await this.setRangeFont(root_child_1, 0, 10, {"family":"Open Sans","style":"Regular"});
root_child_1.setRangeFills(0, 10, [{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0.10196078568696976,"g":0.1921568661928177,"b":0.23529411852359772},"boundVariables":{}}]);
root_child_1.setRangeFontSize(0, 10, 16);
root.appendChild(root_child_1);
// Child Layout Props
root_child_1.layoutAlign = "INHERIT";
root_child_1.layoutGrow = 0;
applySizeAndTransform(root_child_1, {"width":83,"height":24,"relativeTransform":[[1,0,24],[0,1,0]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});


        applySizeAndTransform(root, {"width":107,"height":24,"parentIsAutoLayout":false});

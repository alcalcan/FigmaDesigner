...
export class Header extends BaseComponent {
    async create(props: ComponentProps): Promise<SceneNode> {
        ...
        root_child_0_child_0_child_0.characters = title;
        ...
        // Styled Segments
        await this.setRangeFont(root_child_0_child_0_child_0, 0, title.length, { "family": "Open Sans", "style": "Regular" });
        root_child_0_child_0_child_0.setRangeFills(0, title.length, [{ "type": "SOLID", "visible": true, "opacity": 1, "blendMode": "NORMAL", "color": { "r": 1, "g": 1, "b": 1 }, "boundVariables": {} }]);
        root_child_0_child_0_child_0.setRangeFontSize(0, title.length, 40);
        ...
        root_child_1_child_0_child_0.characters = subtitle;
        ...
        // Styled Segments
        await this.setRangeFont(root_child_1_child_0_child_0, 0, subtitle.length, { "family": "Open Sans", "style": "SemiBold" });
        root_child_1_child_0_child_0.setRangeFills(0, subtitle.length, [{ "type": "SOLID", "visible": true, "opacity": 1, "blendMode": "NORMAL", "color": { "r": 1, "g": 1, "b": 1 }, "boundVariables": {} }]);
        root_child_1_child_0_child_0.setRangeFontSize(0, subtitle.length, 16);

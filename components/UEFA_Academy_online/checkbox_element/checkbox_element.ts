...
export class checkbox_element extends BaseComponent {
    async create(props: ComponentProps): Promise<SceneNode> {
        ...
        // Start Child: Shape
        const root_child_0_child_0 = figma.createFrame(); // Fallback for BOOLEAN_OPERATION
        ...
        root_child_1.fontName = { "family": "Open Sans", "style": "Regular" };
        // Styled Segments
        await figma.loadFontAsync({ "family": "Open Sans", "style": "Regular" });
        root_child_1.setRangeFontName(0, 11, { "family": "Open Sans", "style": "Regular" });

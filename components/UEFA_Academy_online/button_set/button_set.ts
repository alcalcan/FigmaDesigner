...
export class button_set extends BaseComponent {
...
if ("layoutMode" in root_child_0) {
    ...
    root_child_0.itemSpacing = 12;
    root_child_0.paddingTop = 12;
    root_child_0.paddingRight = 24;
    root_child_0.paddingBottom = 12;
    root_child_0.paddingLeft = 24;
...
root_child_0.strokes = await this.hydratePaints([{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0,"g":0.6352941393852234,"b":0.5882353186607361},"boundVariables":{}}]);
...
if ("cornerRadius" in root_child_0) root_child_0.cornerRadius = 24;

// Start Child: Label
const root_child_0_child_0 = figma.createText();
root_child_0_child_0.name = "Label";
...
root_child_0_child_0.fills = await this.hydratePaints([{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0,"g":0.6352941393852234,"b":0.5882353186607361},"boundVariables":{}}]);
...
// Text Properties
root_child_0_child_0.characters = `Cancel`;
root_child_0_child_0.fontSize = 16;
root_child_0_child_0.textAlignHorizontal = "CENTER";
...
root_child_0_child_0.lineHeight = {"unit":"PERCENT","value":150};
...
root_child_0_child_0.paragraphSpacing = 16;
root_child_0_child_0.paragraphIndent = 0;
await this.setFont(root_child_0_child_0, {"family":"Manrope","style":"SemiBold"});
// Styled Segments
await this.setRangeFont(root_child_0_child_0, 0, 6, {"family":"Manrope","style":"SemiBold"});
root_child_0_child_0.setRangeFills(0, 6, [{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0,"g":0.6352941393852234,"b":0.5882353186607361},"boundVariables":{}}]);
root_child_0_child_0.setRangeFontSize(0, 6, 16);
root_child_0.appendChild(root_child_0_child_0);
// Child Layout Props
root_child_0_child_0.layoutAlign = "INHERIT";
root_child_0_child_0.layoutGrow = 0;
applySizeAndTransform(root_child_0_child_0, {"width":54,"height":24,"relativeTransform":[[1,0,24],[0,1,12]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
root.appendChild(root_child_0);
// Child Layout Props
root_child_0.layoutAlign = "INHERIT";
root_child_0.layoutGrow = 0;
applySizeAndTransform(root_child_0, {"width":102,"height":48,"relativeTransform":[[1,0,0],[0,1,0]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});

// Start Child: pk-button
const root_child_1 = figma.createFrame();
root_child_1.name = "pk-button";
...
if ("layoutMode" in root_child_1) {
    ...
    root_child_1.paddingTop = 12;
    root_child_1.paddingRight = 24;
    root_child_1.paddingBottom = 12;
    root_child_1.paddingLeft = 24;
    root_child_1.itemReverseZIndex = false;
    root_child_1.strokesIncludedInLayout = false;
}
root_child_1.fills = await this.hydratePaints([{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0,"g":0.6352941393852234,"b":0.5882353186607361},"boundVariables":{}}]);
...
if ("cornerRadius" in root_child_1) root_child_1.cornerRadius = 24;

// Start Child: Label
const root_child_1_child_0 = figma.createText();
root_child_1_child_0.name = "Label";
...
root_child_1_child_0.fills = await this.hydratePaints([{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":1,"g":1,"b":1},"boundVariables":{}}]);
root_child_1_child_0.strokes = await this.hydratePaints([]);
root_child_1_child_0.strokeWeight = 0;
root_child_1_child_0.strokeAlign = "CENTER";
...
// Text Properties
root_child_1_child_0.characters = `Save`;
root_child_1_child_0.fontSize = 16;
root_child_1_child_0.textAlignHorizontal = "CENTER";
root_child_1_child_0.textAlignVertical = "CENTER";
root_child_1_child_0.textAutoResize = "WIDTH_AND_HEIGHT";
root_child_1_child_0.letterSpacing = {"unit":"PIXELS","value":0};
root_child_1_child_0.lineHeight = {"unit":"PERCENT","value":150};
if ("textCase" in root_child_1_child_0) root_child_1_child_0.textCase = "ORIGINAL";
if ("textDecoration" in root_child_1_child_0) root_child_1_child_0.textDecoration = "NONE";
root_child_1_child_0.paragraphSpacing = 16;
root_child_1_child_0.paragraphIndent = 0;
await this.setFont(root_child_1_child_0, {"family":"Manrope","style":"SemiBold"});
// Styled Segments
await this.setRangeFont(root_child_1_child_0, 0, 4, {"family":"Manrope","style":"SemiBold"});
root_child_1_child_0.setRangeFills(0, 4, [{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":1,"g":1,"b":1},"boundVariables":{}}]);
root_child_1_child_0.setRangeFontSize(0, 4, 16);
root_child_1.appendChild(root_child_1_child_0);
// Child Layout Props
root_child_1_child_0.layoutAlign = "INHERIT";
root_child_1_child_0.layoutGrow = 0;
applySizeAndTransform(root_child_1_child_0, {"width":37,"height":24,"relativeTransform":[[1,0,77.5],[0,1,12]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
root.appendChild(root_child_1);
// Child Layout Props
root_child_1.layoutAlign = "INHERIT";
root_child_1.layoutGrow = 0;
applySizeAndTransform(root_child_1, {"width":192,"height":48,"relativeTransform":[[1,0,114],[0,1,0]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});


        applySizeAndTransform(root, {"width":306,"height":48,"parentIsAutoLayout":false});

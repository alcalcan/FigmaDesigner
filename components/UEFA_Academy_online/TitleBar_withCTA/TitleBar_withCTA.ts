...
// Text Properties
root_child_0_child_0.characters = `Notification preferences`;
...
// Styled Segments
await this.setRangeFont(root_child_0_child_0, 0, 24, {"family":"Open Sans","style":"Regular"});
root_child_0_child_0.setRangeFills(0, 24, [{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0.10196078568696976,"g":0.1921568661928177,"b":0.23529411852359772},"boundVariables":{}}]);
root_child_0_child_0.setRangeFontSize(0, 24, 32);
root_child_0.appendChild(root_child_0_child_0);
// Child Layout Props
root_child_0_child_0.layoutAlign = "INHERIT";
root_child_0_child_0.layoutGrow = 0;
applySizeAndTransform(root_child_0_child_0, {"width":361,"height":40,"relativeTransform":[[1,0,0],[0,1,0]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
...
// Text Properties
root_child_0_child_1.characters = `Choose what you want to receive updates about`;
...
root_child_0_child_1.textAutoResize = "WIDTH_AND_HEIGHT";
...
// Styled Segments
await this.setRangeFont(root_child_0_child_1, 0, 45, {"family":"Inter","style":"Medium"});
root_child_0_child_1.setRangeFills(0, 45, [{"type":"SOLID","visible":true,"opacity":1,"blendMode":"NORMAL","color":{"r":0.2705882489681244,"g":0.3607843220233917,"b":0.40392157435417175},"boundVariables":{}}]);
root_child_0_child_1.setRangeFontSize(0, 45, 16);
root_child_0.appendChild(root_child_0_child_1);
// Child Layout Props
root_child_0_child_1.layoutAlign = "INHERIT";
root_child_0_child_1.layoutGrow = 0;
applySizeAndTransform(root_child_0_child_1, {"width":357,"height":24,"relativeTransform":[[1,0,0],[0,1,48]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
root.appendChild(root_child_0);
// Child Layout Props
root_child_0.layoutAlign = "INHERIT";
root_child_0.layoutGrow = 1;
applySizeAndTransform(root_child_0, {"width":1110,"height":72,"relativeTransform":[[1,0,0],[0,1,0]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
...
applySizeAndTransform(root_child_1, {"width":306,"height":48,"relativeTransform":[[1,0,1134],[0,1,0]],"parentIsAutoLayout":true,"layoutPositioning":"AUTO"});
        ...
        applySizeAndTransform(root, {"width":1440,"height":72,"parentIsAutoLayout":false});

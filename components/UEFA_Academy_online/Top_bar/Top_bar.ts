...
// SVG Assets
const SVG_assets_vector_UEFA_com_3379_17577_svg = `<svg width="54" height="16" viewBox="0 0 54 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
const SVG_assets_icon_Vector_3379_18133_svg = `<svg width="15" height="20" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const root_child_0_child_0_child_0_child_0_child_0_svgContainer = figma.createNodeFromSvg(SVG_assets_vector_UEFA_com_3379_17577_svg);
...
// Start Child: Vector
const root_child_1_child_0_child_0_svgContainer = figma.createNodeFromSvg(SVG_assets_icon_Vector_3379_18133_svg);
...
root_child_1_child_1_child_0_child_0_child_0_child_1.fontName = {"family":"Manrope","style":"Bold"};
// Styled Segments
await figma.loadFontAsync({"family":"Manrope","style":"Bold"});
root_child_1_child_1_child_0_child_0_child_0_child_1.setRangeFontName(0, 2, {"family":"Manrope","style":"Bold"});
...
root_child_1_child_1_child_0_child_0_child_1.fontName = {"family":"Open Sans","style":"Regular"};
// Styled Segments
await figma.loadFontAsync({"family":"Open Sans","style":"Regular"});
root_child_1_child_1_child_0_child_0_child_1.setRangeFontName(0, 8, {"family":"Open Sans","style":"Regular"});
...
// Start Child: Line 43
const root_child_1_child_1_child_0_child_1 = figma.createFrame(); // Fallback for LINE
...
// Start Child: Union
const root_child_1_child_2_child_0 = figma.createFrame(); // Fallback for BOOLEAN_OPERATION
...
root_child_1_child_2_child_0.appendChild(root_child_1_child_2_child_0_child_2);

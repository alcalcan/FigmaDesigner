...
// SVG Assets
import IMG_Real_Sociedad_img_1_png from "././assets/Real_Sociedad_img_1.png";


export class Real_Sociedad extends BaseComponent {
                ...
                "fills": [
                  {
                    ...
                    "assetRef": IMG_Real_Sociedad_img_1_png
                  }
                ],
                "strokes": [],
                "effects": [],

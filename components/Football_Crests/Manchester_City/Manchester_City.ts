...
// SVG Assets
import IMG_Manchester_City_img_1_png from "././assets/Manchester_City_img_1.png";


export class Manchester_City extends BaseComponent {
                ...
                "fills": [
                  {
                    ...
                    "assetRef": IMG_Manchester_City_img_1_png
                  }
                ],
                "strokes": [],
                "effects": [],

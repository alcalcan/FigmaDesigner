...
export class PPT_Euro28BookingComPromotionInSecutixTicketingPortal2_Slide_011 extends BaseComponent {
    async create(props: ComponentProps): Promise<FrameNode> {
        const slide = figma.createFrame();
        slide.name = "Slide_011";
        slide.resize(1280, 720);
        slide.x = props.x ?? 0;
        slide.y = props.y ?? 0;


        slide.fills = [{ type: "SOLID", color: { r: 0, g: 0.69, b: 0.314 }, opacity: 1 }];

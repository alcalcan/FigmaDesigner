...
export class PPT_Euro28BookingComPromotionInSecutixTicketingPortal2_Slide_002 extends BaseComponent {
    async create(props: ComponentProps): Promise<FrameNode> {
        const slide = figma.createFrame();
        slide.name = "Slide_002";
        ...
        text_5.name = "Text_5";
        const text_5_font: FontName = { family: "Europa Nuova Bold", style: "Regular" };
        try {
            text_5.fontName = text_5_font;
        } catch (_fontApplyErr) {
            // Keep fallback font when requested font style is unavailable.
        }
        text_5.characters = "Context\nGoal\nSolutions";
        text_5.x = 478.529;
        text_5.y = 141.607;
        text_5.resize(731.723, 585.15);
        text_5.textAutoResize = "NONE";
        text_5.setRangeFills(0, 8, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(0, 8, { family: "Europa Nuova Bold", style: "Regular" });
            text_5.setRangeFontSize(0, 8, 24);
        } catch (_runFontErr) {}
        text_5.setRangeFills(8, 13, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(8, 13, { family: "Europa Nuova Bold", style: "Regular" });
            text_5.setRangeFontSize(8, 13, 24);
        } catch (_runFontErr) {}
        text_5.setRangeFills(13, 22, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(13, 22, { family: "Europa Nuova Bold", style: "Regular" });
            text_5.setRangeFontSize(13, 22, 24);
        } catch (_runFontErr) {}
        ...
        text_6.setRangeFills(31, 49, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_6.setRangeFontName(31, 49, { family: "Europa Nuova", style: "Regular" });
            text_6.setRangeFontSize(31, 49, 28);
        } catch (_runFontErr) {}
        ...
        text_7.characters = "Index";
        text_7.x = 72.567;
        text_7.y = 141.607;
        text_7.resize(354.049, 492.448);
        text_7.textAutoResize = "NONE";
        text_7.setRangeFills(0, 5, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_7.setRangeFontName(0, 5, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_7.setRangeFontSize(0, 5, 44);
        } catch (_runFontErr) {}

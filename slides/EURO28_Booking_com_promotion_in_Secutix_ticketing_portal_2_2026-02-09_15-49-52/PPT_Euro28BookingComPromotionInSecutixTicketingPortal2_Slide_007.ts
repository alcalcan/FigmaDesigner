...
export class PPT_Euro28BookingComPromotionInSecutixTicketingPortal2_Slide_007 extends BaseComponent {
    async create(props: ComponentProps): Promise<FrameNode> {
        const slide = figma.createFrame();
        slide.name = "Slide_007";
        ...
        const image_5_raw = IMG_img_0002_png;
        ...
        if (image_5_str && image_5_str.trim().startsWith('<svg')) {
            ...
            image_5.resize(1087.885, 631.59);
            image_5.x = 138.781;
            image_5.y = 44.205;
        } else {
            // Raster Image Asset
        ...
        // Detect image type and create corresponding Figma node
        const image_6_raw = IMG_img_0003_png;
        ...
        if (image_6_str && image_6_str.trim().startsWith('<svg')) {
            ...
            image_6.resize(232.896, 470.761);
            image_6.x = 113.883;
            image_6.y = 205.034;
        } else {
            // Raster Image Asset
        ...
        text_7.characters = "Option A.\nSponsor strip";
        text_7.x = -421.316;
        text_7.y = 141.607;
        text_7.resize(354.049, 88.562);
        ...
        text_7.setRangeFills(10, 23, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_7.setRangeFontName(10, 23, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_7.setRangeFontSize(10, 23, 32);
        } catch (_runFontErr) {}
        ...
        text_8.setRangeFills(0, 48, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_8.setRangeFontName(0, 48, { family: "Europa Nuova", style: "Regular" });
            text_8.setRangeFontSize(0, 48, 28);
        } catch (_runFontErr) {}
        ...
        try {
            text_9.setRangeFontName(5, 77, { family: "Europa Nuova Bold", style: "Regular" });
            text_9.setRangeFontSize(5, 77, 16);
        } catch (_runFontErr) {}
        try {
            text_9.setRangeFontName(77, 83, { family: "Europa Nuova Bold", style: "Regular" });
            text_9.setRangeFontSize(77, 83, 16);
        } catch (_runFontErr) {}
        try {
            text_9.setRangeFontName(83, 127, { family: "Europa Nuova Bold", style: "Regular" });
            text_9.setRangeFontSize(83, 127, 16);
        } catch (_runFontErr) {}
        try {
            text_9.setRangeFontName(127, 138, { family: "Europa Nuova Bold", style: "Regular" });
            text_9.setRangeFontSize(127, 138, 16);
        } catch (_runFontErr) {}
        try {
            text_9.setRangeFontName(138, 332, { family: "Europa Nuova Bold", style: "Regular" });
            text_9.setRangeFontSize(138, 332, 16);
        } catch (_runFontErr) {}

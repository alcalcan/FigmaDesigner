...
export class PPT_Euro28BookingComPromotionInSecutixTicketingPortal2_Slide_001 extends BaseComponent {
    async create(props: ComponentProps): Promise<FrameNode> {
        const slide = figma.createFrame();
        slide.name = "Slide_001";
        ...
        text_5.characters = "EURO28\n\nBooking.com promotion\nin Secutix ticketing portal";
        text_5.x = 72.567;
        text_5.y = 400;
        text_5.resize(1107.222, 231.325);
        text_5.textAutoResize = "NONE";
        text_5.setRangeFills(0, 6, [{ type: "SOLID", color: { r: 1, g: 0, b: 0.984 } }]);
        try {
            text_5.setRangeFontName(0, 6, { family: "Europa Nuova", style: "Regular" });
            text_5.setRangeFontSize(0, 6, 24);
        } catch (_runFontErr) {}
        text_5.setRangeFills(8, 19, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(8, 19, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_5.setRangeFontSize(8, 19, 60);
        } catch (_runFontErr) {}
        text_5.setRangeFills(19, 29, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(19, 29, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_5.setRangeFontSize(19, 29, 60);
        } catch (_runFontErr) {}
        text_5.setRangeFills(30, 33, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(30, 33, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_5.setRangeFontSize(30, 33, 60);
        } catch (_runFontErr) {}
        text_5.setRangeFills(33, 40, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(33, 40, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_5.setRangeFontSize(33, 40, 60);
        } catch (_runFontErr) {}
        text_5.setRangeFills(40, 57, [{ type: "SOLID", color: { r: 1, g: 1, b: 1 } }]);
        try {
            text_5.setRangeFontName(40, 57, { family: "Europa Nuova Extra Bold", style: "Regular" });
            text_5.setRangeFontSize(40, 57, 60);
        } catch (_runFontErr) {}

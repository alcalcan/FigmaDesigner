...
export class Slide_Divider_extra extends BaseComponent {
    async create(props: ComponentProps): Promise<FrameNode> {
        const slide = figma.createFrame();
        slide.name = "Slide_Divider_extra";
        ...
        subtitleText.characters = props.body || "Section intro: what this chapter will cover and why it matters.";

...
export class Slide_Divider_Subtle_Gray_extra extends BaseComponent {
    async create(props: ComponentProps): Promise<FrameNode> {
        const slide = figma.createFrame();
        slide.name = "Slide_Divider_Subtle_Gray_extra";
        ...
        subtitleText.characters = props.body || "Subsection setup text with a one-line message for audience orientation.";
